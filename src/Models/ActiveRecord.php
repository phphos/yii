...
use PHPHos\Yii\Exceptions\Exception;
use PHPHos\Yii\Models\SoftDeleteBehavior;
use Yii;
...
abstract class ActiveRecord extends BaseActiveRecord
{
    ...
    public static function findAlias(
        ...
        $andWhere && $query->andWhere(static::andWhere($alias));
    ...
    public static function updateAll($attributes, $condition = '', $params = [])
    {
        ...
        $condition = ['AND', $condition, static::andWhere('')];
     ...
     * @return array
     */
    protected static function andWhere(string $alias = ''): array
    {
        $alias .= $alias ? '.' : '';
