...
namespace PHPHos\Yii\Templates\Model;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $tableName;
    public $modelClass;
    public $baseClass = '\PHPHos\Yii\Models\Model';
    ...
    protected function checkJunctionTable($table)
    {
        ...
        for ($i = 0; $i < $foreignKeysCount; $i++) {
            ...
            for ($j = bcadd($i, 1); $j < $foreignKeysCount; $j++) {
    ...
    protected function getTableNames()
    {
        ...
        if (strpos($this->tableName, '*') !== false) {
            if (($pos = strrpos($this->tableName, '.')) !== false) {
                ...
                $pattern = '/^' . str_replace('*', '\w+', substr($this->tableName, bcadd($pos, 1))) . '$/';
            } else {
                $schema = '';
    ...
    protected function generateClassName($tableName, $useSchemaName = null)
    {
        ...
        if (($pos = strrpos($tableName, '.')) !== false) {
            ...
            $tableName = substr($tableName, bcadd($pos, 1));
        }
        ...
        if (strpos($this->tableName, '*') !== false) {
            ...
            if (($pos = strrpos($pattern, '.')) !== false) {
                $pattern = substr($pattern, bcadd($pos, 1));
            }
